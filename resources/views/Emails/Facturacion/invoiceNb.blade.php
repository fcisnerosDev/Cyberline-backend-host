  ...
  color: #0000CC">
            ...
            <div
                ...
                <p id="boleto_header_6"
                    ...
                    NOTA DE DÉBITO<br> ELECTR&Oacute;NICA
                </p>
                <p id="boleto_header_7"
                    ...
                    {{ $notaDebito->serie }} - {{ $notaDebito->correlativo }}
                </p>
            </div>
        </div>
        {{--  --}}
            ...
            <div class="col-lg-9">
                <div class="card card-body">
                    <p style="text-factura">
                        ...
                        RAZON SOCIAL :
                        {{ $notaDebito->client->rzn_social ?? 'No disponible' }}
                    </p>

                    <p style="text-factura">

                        RUC :
                        {{ $notaDebito->client->num_doc ?? 'No disponible' }}
                    </p>

                    <p style="text-factura">

                        DIRECCIÓN:
                        {{ $notaDebito->client->direccion ?? 'No disponible' }}
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="card2 card-white">
                    <p class="text-factura">
                        ...
                        {{ \Carbon\Carbon::parse($notaDebito->fecha_emision)->format('d/m/Y') }}
                    </p>
                    ...
                    <p class="text-factura">
                        ...
                        CONDICIÓN DE PAGO :
                        {{ $notaDebito->forma_pago_tipo }}
                    </p>

                    <p class="text-factura">

                        MONEDA :
                        {{ $notaDebito->tipo_moneda == 'PEN' ? 'NUEVOS SOLES' : ($notaDebito->tipo_moneda == 'USD' ? 'DÓLARES AMERICANOS' : $notaDebito->tipo_moneda) }}
            ...
            <div class="col-lg-12">
                <div class="card card-body">
                    <p style="text-factura">
                        ...
                        DOCUMENTO AFECTADO :
                        {{ $notaDebito->num_doc_afectado ?? 'No disponible' }}
                    </p>

                    <p style="text-factura">

                        CODIGO DE MOTIVO :
                        {{ $notaDebito->cod_motivo ?? 'No disponible' }}
                    </p>

                    <p style="text-factura">

                        MOTIVO :
                        {{ $notaDebito->des_motivo ?? 'No disponible' }}
                    </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                @if ($notaDebito->invoiceDetails && $notaDebito->invoiceDetails->count())
                        ...
                        <div class="col-lg-3">
                            <div class="card2 card-white">
                                <p class="text-factura">
                                    @foreach ($notaDebito->invoiceDetails as $detalle)
                                        SUBTOTAL :
                                        {{ $notaDebito->tipo_moneda == 'PEN' ? 'S/.' : ($notaDebito->tipo_moneda == 'USD' ? '$' : $notaDebito->tipo_moneda) }}
